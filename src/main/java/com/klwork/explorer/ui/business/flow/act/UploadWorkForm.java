...
public class UploadWorkForm extends PublishNeedForm {
	...
	public UploadWorkForm(Task task) {
		super(task);
	...
	protected void initActions() {
		submitFormButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				try {
					...
					fireEvent(new SubmitEvent(UploadWorkForm.this,
		...
		cancelFormButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				fireEvent(new FormPropertiesEvent(UploadWorkForm.this,
