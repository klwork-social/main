 ...
 */
public class SinaWeiboDisplayPage extends DetailPanel {
	/**
	 * 
	 */
	...
	protected Image currentImage(String retweetedBmiddlePic, String defualt,String add) {
		...
		if (StringTool.judgeBlank(retweetedBmiddlePic)) {
			image = new Image(null, new ExternalResource(retweetedBmiddlePic));
		} else {
			...
			VerticalLayout secondLayout = new VerticalLayout() {
				{
					...
					descriptionField.setValue(SinaSociaTool.textTranslate(userWeibo.getText()));
					...
					if(userWeibo.getRetweetedId() != null){
						...
						//原帖内容
						Label l = new Label(SinaSociaTool.textTranslate(orginWeibo.getText()));
			...
			VerticalLayout thirdLayout = new VerticalLayout() {
				{
					...
					setComponentAlignment(addButton,
