...
public class OutProjectManagerLeft extends AbstractAccordionComponent {
	...
	protected void initUi() {
		super.initUi();
		addAccordion(new OutProjectOfMyAddInManager(mainPage), "我参与的项目");
		OutProjectOfMyPublishManager myPublishObj = new OutProjectOfMyPublishManager(mainPage);
		addAccordion(myPublishObj, "我发布的项目");
		selectedAccordion(myPublishObj);
	}
