 ...
 */
public class GroupMenuBar extends ToolBar {
  ...
  protected void initItems() {
    ...
    ToolbarEntry teamManagerEntry = addToolbarEntry("team_manager", i18nManager.getMessage(Messages.ORGANIZATION_TEAM_MANAGER), new ToolbarCommand() {
      public void toolBarItemSelected() {
    	  ViewToolManager.getMainView().showOrganizationMain();
      }
    });
    
    ToolbarEntry teamMemberEntry = addToolbarEntry("team_member", i18nManager.getMessage(Messages.ORGANIZATION_TEAM_MEMBER), new ToolbarCommand() {
        public void toolBarItemSelected() {
        	ViewToolManager.getMainView().showOrganMemberMain();
        }
      });
