...
public class ProjectOfMyAddInManagerLeft extends AbstractVCustomComponent {
	...
	ProjectOfMyAddInMainPage mainPage;
	TeamService teamService;
	OutsourcingProject outsourcingProject;

	public ProjectOfMyAddInManagerLeft(ProjectOfMyAddInMainPage projectMain) {
	...
	public void initProjectTable(VerticalLayout tableLayout) {
		...
		if (lazyLoadingQuery.size() > 0) {
			...
			Label noMembersTable = new Label(
					i18nManager
							.getMessage(Messages.OUTPROJECT_PARTICIPANT_NO_PROJECTS));
