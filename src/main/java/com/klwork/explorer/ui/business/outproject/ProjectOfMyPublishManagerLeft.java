...
public class ProjectOfMyPublishManagerLeft extends AbstractVCustomComponent {
	...
	ProjectOfMyPublishMainPage mainPage;
	TeamService teamService;
	
	OutsourcingProject outsourcingProject;

	public ProjectOfMyPublishManagerLeft(ProjectOfMyPublishMainPage mainPage) {
