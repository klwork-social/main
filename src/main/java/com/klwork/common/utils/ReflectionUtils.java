...
public class ReflectionUtils {
	 ...
	 * @param types
	 */
	public static <T> void copyValueFromOtherObject(T oldObject,
			T newObject, String[] names, Class[] types) {
		for (int i = 0; i < names.length; i++) {
			String name = names[i];
			Object value = ReflectionUtils.invokeGetterMethod(newObject, name);
			ReflectionUtils.invokeSetterMethod(oldObject,name,value,types[i]);
		}
	}
