...
public abstract class AbstractSession implements Session {
	...
	public boolean isLinked() {
		...
		if (useWeiboToken) {
			if (weiboAccessToken != null
					&& StringTool.judgeBlank(weiboAccessToken.mAccessToken)) {
				return true;
			}
			return false;
		} else {
			if (accessToken != null
					&& StringTool.judgeBlank(accessToken.mAccessToken)) {
				return true;
			}
			return false;
		}
	...
	public void sign(HttpRequest request) {
		...
		if (useWeiboToken) {
			...
			Log.debug("access_Token", this.accessToken.mAccessToken);
		}
