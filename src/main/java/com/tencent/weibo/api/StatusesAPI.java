...
public class StatusesAPI extends BasicAPI {
	 ...
	 */
	public String homeTimeline(TimelineParameter parameterObject) throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", parameterObject.format));
		paramsList.add(new BasicNameValuePair("pageflag", parameterObject.pageflag));
		paramsList.add(new BasicNameValuePair("pagetime", parameterObject.pagetime));
		paramsList.add(new BasicNameValuePair("reqnum", parameterObject.reqnum));
        paramsList.add(new BasicNameValuePair("type", parameterObject.type));
        paramsList.add(new BasicNameValuePair("contenttype", parameterObject.contenttype));
		
		return requestAPI.getResource(statusesHomeTimelineUrl,
				paramsList, parameterObject.oAuth);
	}
	 ...
	 */
	public String mentionsTimeline(TimelineParameter parameterObject)
			throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", parameterObject.format));
		paramsList.add(new BasicNameValuePair("pageflag", parameterObject.pageflag));
		paramsList.add(new BasicNameValuePair("pagetime", parameterObject.pagetime));
		paramsList.add(new BasicNameValuePair("reqnum", parameterObject.reqnum));
		paramsList.add(new BasicNameValuePair("lastid", parameterObject.lastid));
        paramsList.add(new BasicNameValuePair("type", parameterObject.type));
        paramsList.add(new BasicNameValuePair("contenttype", parameterObject.contenttype));
	 ...
	 */
	public String broadcastTimeline(TimelineParameter parameterObject)
			throws Exception {
		QArrayList paramsList = new QArrayList();
		paramsList.add(new BasicNameValuePair("format", parameterObject.format));
		paramsList.add(new BasicNameValuePair("pageflag", parameterObject.pageflag));
